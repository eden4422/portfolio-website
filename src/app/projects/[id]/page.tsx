  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="w-full max-w-5xl mx-auto px-6 pt-28 pb-12">
        ...
        {/* Links */}
        <section className="flex flex-wrap gap-4 pt-8 border-t border-gray-200">
          {project.githubUrl && (
            <a
          ...
          {project.previousGithubUrl && (
            <a
              href={project.previousGithubUrl}
              target="_blank"
              rel="noopener noreferrer"
          ...
          {project.previousLiveUrl && (
            <a
              href={project.previousLiveUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-indigo-500 text-white px-6 py-3 rounded-lg hover:bg-indigo-600 transition-colors font-medium"
            >
              <svg
                className="w-5 h-5"
                fill="none"
